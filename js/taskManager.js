const createTaskHtml =(category, name, description, assignedTo, email, dueDate, status) => {
...
class TaskManager {
    ...
    this.tasks.forEach(task => {
      ...
      let taskHtml =createTaskHtml(currentTask.task.category, currentTask.task.name, currentTask.task.description, currentTask.task.assignedTo, currentTask.task.email,currentTask.task.dueDate, currentTask.task.status)
